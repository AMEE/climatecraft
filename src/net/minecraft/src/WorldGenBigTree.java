...
public class WorldGenBigTree extends WorldGenerator
{
	...
	boolean isGrowingFromSapling = false;

    public WorldGenBigTree(boolean _isGrowingFromSapling)
    {
    	isGrowingFromSapling = _isGrowingFromSapling;
        rand = new Random();
        heightLimit = 0;
